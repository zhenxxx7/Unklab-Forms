...
export default function CheckingF() {
    ...
    return (
        <div>
            <div>
            <button type="button" class="mt-2 text-stone-800 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2  dark:text-stone-800 dark:focus:ring-orange-400" onClick={() => navigate ("/home")}>
