        ...
        <div>
            ...
            <div>              
                <form className="mx-auto mt-8 px-4">   
                    ...
                    <div class="relative">
                        <input type="search" id="default-search" class="block w-full p-4 pl-10 text-sm border-2 focus:outline-none border-stone-600 rounded-2xl" placeholder="Token" required></input>
